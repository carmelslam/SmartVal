-- RESTORE THE ORIGINAL WORKING SQL (from debug cascading search.md line 844-1212)
-- This version worked - no timeout, proper cascading
-- The real issue is the UI not sending part parameters, NOT the SQL
