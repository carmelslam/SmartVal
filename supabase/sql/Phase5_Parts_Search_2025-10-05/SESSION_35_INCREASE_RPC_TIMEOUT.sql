-- ============================================================================
-- SESSION 35: Fix RPC Timeout on First Search
-- Date: 2025-10-15
-- Problem: smart_parts_search times out on first attempt (cold start)
-- Solution: Increase statement timeout from default 3s to 15s
-- ============================================================================

-- This is a simple one-line fix to the existing search function
-- The function does complex cascading searches with multiple EXECUTE statements
-- First search after idle hits cold cache and times out
-- Subsequent searches work because query plans and indexes are cached
...
-- This will replace the existing function with timeout protection
-- ============================================================================
