-- DROP AND RE-DEPLOY SMART PARTS SEARCH FUNCTIONS
-- This script drops existing functions first to avoid conflicts

-- ============================================================================
-- STEP 1: DROP EXISTING FUNCTIONS
-- ============================================================================

-- Drop the main search function if it exists
...
-- Drop the JSON wrapper function if it exists
...
-- ============================================================================
-- STEP 3: CREATE JAVASCRIPT WRAPPER FUNCTION
-- ============================================================================
...
-- Success message
SELECT 'SUCCESS: Functions dropped and re-deployed!' as status;