-- =====================================================
-- Phase 9: Drop All Versions of Expertise Function
-- Date: 2025-10-25
-- Purpose: Remove duplicate function versions before applying correct one
-- =====================================================

-- Drop all versions of upsert_tracking_expertise_from_helper
-- This handles all possible parameter combinations from migrations 03, 12, 16, 17

-- Version 1: Original (3 params) from migration 03
DROP FUNCTION IF EXISTS upsert_tracking_expertise_from_helper(JSONB, UUID, TEXT);

-- Version 2: With status (4 params) from migration 12
DROP FUNCTION IF EXISTS upsert_tracking_expertise_from_helper(JSONB, UUID, TEXT, TEXT);

-- Version 3: With PDF params (6 params) from migration 16
DROP FUNCTION IF EXISTS upsert_tracking_expertise_from_helper(JSONB, UUID, TEXT, TEXT, TEXT, TEXT);

-- Now recreate the CORRECT version from migration 17
