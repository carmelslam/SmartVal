-- SIMPLE EXTRACTION - SAFE VERSION
-- Run this COMPLETE script - no problematic characters
...
DECLARE
    side_result TEXT;
BEGIN
    -- English patterns (since Hebrew causes issues)
    ...
    -- Try to detect Hebrew patterns without using Hebrew characters
    IF desc_text ~ '[אבגדהוזחטיכלמנסעפצקרשת]' THEN
        -- Contains Hebrew - try position-based detection
