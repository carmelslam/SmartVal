...
## 🆕 UPDATE: Additional Features & Bug Fixes

### Bug Fixes Applied (Same Day - 2025-11-22)
See `BUGFIXES_2025-11-22.md` for complete details:

1. ✅ **Gallery Loading** - Changed from `.filter()` to JavaScript filtering (compatibility fix)
2. ✅ **Delete Function** - Direct Supabase UPDATE instead of RPC
3. ✅ **Restore Function** - Direct Supabase UPDATE instead of RPC
4. ✅ **Reordering** - Batch Promise.all() updates instead of RPC
5. ✅ **Header Visibility** - White text with shadow on purple background
6. ✅ **Empty Dropdown** - Auto-hide damage center filter when no centers exist

### AI Smart Names Feature
**Added:** Display AI-generated names instead of filenames
**Logic:**
- If AI recognized both part and damage: `"front_bumper - deep_scratch"`
- If only part: `"front_bumper"`
- If only damage: `"deep_scratch"`
- If "חלק לא ברור" (unclear): Fallback to filename
- If no AI data: Fallback to filename

**Code Location:** Lines 2126-2140, 2156-2158
**User Benefit:** More meaningful, organized image names
...
- **Files Modified:** 1 (`upload-images.html`)
- **Lines Added:** ~680 (CSS + HTML + JavaScript)
- **External Dependencies:** 1 (SortableJS CDN)
- **Database Changes:** 0 (all columns already existed)
- **Breaking Changes:** 0
...
- ✅ Soft Delete/Restore
- ✅ Damage Center Display & Filter
- ✅ Category Display with Hebrew Labels
- ✅ AI Smart Name Display
